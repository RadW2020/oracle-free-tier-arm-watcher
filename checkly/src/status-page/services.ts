...
export const eduSchedulerApiService = new StatusPageService('edu-scheduler-api-Y1H8PGDU', {
  name: 'EduScheduler API',
})

export const eduSchedulerWebService = new StatusPageService('edu-scheduler-web-M3syl30T', {
  name: 'EduScheduler Web',
})
