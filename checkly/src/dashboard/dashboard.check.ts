 ...
 *
 * Sin `tags` no filtra nada: entran los 15 checks de las cuatro áreas
 * (Shogunito, Ciaobox, AIDRA e infraestructura OCI), que es justamente la
 * vista única que no existía.
 *
...
new Dashboard('uliber-overview', {
  ...
  description: 'Estado y latencias de todos los servicios: Shogunito, Ciaobox, AIDRA e infraestructura OCI.',
