 ...
 *
 * Sin `tags` no filtra nada: entran los 18 checks de las cinco áreas
 * (Shogunito, Ciaobox, AIDRA, Strong Core e infraestructura OCI), que es
...
new Dashboard('uliber-overview', {
  ...
  description: 'Estado y latencias de todos los servicios: Shogunito, Ciaobox, AIDRA, Strong Core e infraestructura OCI.',
